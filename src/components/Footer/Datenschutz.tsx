...
class Datenschutz extends React.Component<{}, MyComponentStates> {
  ...
  createDataP = () => {
    ...
    dp.push(
      <div className="row text-left align-items-center">
        <div className="col boxkit-datenschutz border border-dark rounded">
          <h2 className="d-none d-sm-block">Datenschutzerklärung</h2>
          <h2 className="d-block d-sm-none">Datenschutz- erklärung</h2>
          <p>
  ...
  render() {
    return <div>{this.createDataP()}</div>;
  }
}
